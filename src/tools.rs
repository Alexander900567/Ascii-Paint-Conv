...
pub fn line(main_window: &mut MainWindow<'_>,
...
pub fn rectangle(main_window: &mut MainWindow<'_>, current_mouse_pos: &[i32; 2], start_mouse_pos: &[i32; 2]){
...
pub fn filled_rectangle(main_window: &mut MainWindow<'_>, current_mouse_pos: &[i32; 2], start_mouse_pos: &[i32; 2]) {
...
pub fn circle(main_window: &mut MainWindow<'_>,
    current_mouse_pos: &[i32; 2],
...
pub fn filled_circle(main_window: &mut MainWindow<'_>, current_mouse_pos: &[i32; 2], start_mouse_pos: &[i32; 2]) { //basically, just fill in line tools, trig if necessary
...
fn draw_ellipse<F>(main_window: &mut MainWindow<'_>, mut render_func: F, current_mouse_pos: &[i32; 2], start_mouse_pos: &[i32; 2]) //necessary for ellipse and filled_ellipse
...
pub fn ellipse(main_window: &mut MainWindow<'_>, current_mouse_pos: &[i32; 2], start_mouse_pos: &[i32; 2]) {
...
pub fn filled_ellipse(main_window: &mut MainWindow<'_>, current_mouse_pos: &[i32; 2], start_mouse_pos: &[i32; 2]) {
...
pub fn text(main_window: &mut MainWindow<'_>, &prev_gpos: &[i32;2], input: &String) -> [i32;2] {
...
pub fn free(main_window: &mut MainWindow<'_>, current_mouse_pos: &[i32; 2], prev_gpos: &[i32; 2]){
